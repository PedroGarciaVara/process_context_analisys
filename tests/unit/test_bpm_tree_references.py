...
from uc_bib_solv.modules.rca_tree.application.use_cases import CausalTreeUseCases
...
class BpmTreeReferenceTests(unittest.TestCase):
    ...
    def test_context_port_and_tree_use_case_are_explicitly_available(self):
        ...
        use_cases = CausalTreeUseCases(object(), object(), object(), object(), queries)
        self.assertEqual(42, use_cases.tree(contract_id="42")["contract_id"])
