...
- **requerimiento_12**: Iniciado 2026-07-30. Estado: `spec_validada`.
  ...
  AMD-001 y AMD-002 integradas. El `spec.md` fue validado explícitamente por el programador humano el 2026-08-01. Siguiente gate: elaboración y aprobación de `task_plan.md`.
