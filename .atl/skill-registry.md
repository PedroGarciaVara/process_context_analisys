...
| `dataiku-oracle-db` | Implementation | Integrar Dataiku y Oracle DB para extracción, transformación y consumo de datos en la aplicación. | `common_spec_driven_development/SKILLs/dataiku-oracle-db/SKILL.md` |
