"""Flask inbound adapter: translate HTTP to injected Process Modeling handlers."""
...
def create_process_modeling_blueprint(handlers):
    ...
    rules = [
        ...
        ("/api/process-modeling/processes/<process_id>", "update_process", "PATCH", lambda process_id: call("update_process", process_id, payload())),
    ...
    for rule, endpoint, method, view in rules:
