...
def create_blueprint(operational, process_modeling):
    ...
    bp.add_url_rule("/api/bpm/machines", "machines_list", lambda: operational_call(operational.list_machines, request.args.get("processId") or request.args.get("process_id"), request.args.get("contract_id") or request.args.get("contractId"), request.args.get("operation_id") or request.args.get("operationId"), request.args.get("process_id"), request.args.get("bpm_process_id")), methods=["GET"])
