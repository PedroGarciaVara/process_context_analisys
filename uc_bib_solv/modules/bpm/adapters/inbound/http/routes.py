"""Canonical HTTP adapters for BPM processes, operations, machines and contracts."""
...
def create_blueprint(operational, process_modeling):
    ...
    bp.add_url_rule("/api/bpm/processes/<process_id>", "process_get", lambda process_id: process_call("get_process", process_id), methods=["GET"])
    ...
    bp.add_url_rule("/api/bpm/processes/<process_id>/versions", "versions_list", lambda process_id: process_call("list_versions", process_id), methods=["GET"])
    bp.add_url_rule("/api/bpm/processes/<process_id>/versions", "versions_create", lambda process_id: created(process_call("create_version", process_id, payload())), methods=["POST"])
    bp.add_url_rule("/api/bpm/versions/<version_id>", "version_get", lambda version_id: process_call("get_version", version_id, request.args.get("expand_node_id")), methods=["GET"])
    bp.add_url_rule("/api/bpm/versions/<version_id>", "version_update", lambda version_id: process_call("update_version", version_id, payload()), methods=["PATCH"])
    bp.add_url_rule("/api/bpm/versions/<version_id>/nodes", "node_create", lambda version_id: created(process_call("create_node", version_id, payload())), methods=["POST"])
    bp.add_url_rule("/api/bpm/versions/<version_id>/operations", "operation_create", lambda version_id: created(process_call("create_operation", version_id, payload())), methods=["POST"])
    ...
    bp.add_url_rule("/api/bpm/operations", "operations_list", lambda: operational_call(operational.list_operations, request.args.get("version_id")), methods=["GET"])
    ...
    bp.add_url_rule("/api/bpm/versions/<version_id>/context", "version_context", lambda version_id: process_call("get_context", version_id, request.args.get("node_id"), request.args.get("family"), request.args.get("record_type")), methods=["GET"])
    ...
    bp.add_url_rule("/api/bpm/versions/<version_id>/transitions", "transition_create", lambda version_id: created(process_call("create_transition", version_id, payload())), methods=["POST"])
    ...
    bp.add_url_rule("/api/bpm/versions/<version_id>/validate", "version_validate", lambda version_id: process_call("validate_version", version_id), methods=["POST"])
    ...
    bp.add_url_rule("/api/bpm/operational/catalog", "operational_catalog", lambda: operational_call(operational.get_catalog, request.args.get("version_id")), methods=["GET"])
    ...
    bp.add_url_rule("/api/bpm/operational/processes/<process_id>", "operational_process_delete", lambda process_id: operational_call(operational.delete_process, process_id), methods=["DELETE"])
    ...
    bp.add_url_rule("/api/bpm/machines", "machines_list", lambda: operational_call(operational.list_machines, request.args.get("processId") or request.args.get("process_id"), request.args.get("contract_id") or request.args.get("contractId"), request.args.get("operation_id") or request.args.get("operationId"), request.args.get("process_version_id") or request.args.get("processVersionId"), request.args.get("bpm_process_id")), methods=["GET"])
    ...
    bp.add_url_rule("/api/bpm/machines/<machine_id>/context", "machine_context", lambda machine_id: operational_call(operational.get_machine_context, machine_id, request.args.get("operation_id") or request.args.get("operationId"), request.args.get("process_version_id") or request.args.get("processVersionId")), methods=["GET"])
