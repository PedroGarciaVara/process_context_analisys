    ...
    <div class="flex flex-1 overflow-hidden">
      <aside class="flex flex-col h-full border-r border-outline-variant p-md bg-surface-container dark:bg-surface-container-low w-[380px] shrink-0">
        ...
        <div class="border-t border-outline-variant pt-md space-y-1">
          <button type="button" class="w-full bg-primary text-on-primary py-sm rounded-lg mb-md font-label-md text-label-md hover:bg-primary-container transition-all" data-route="causa_detalle_v02" data-action="add-evidence">Anadir evidencia</button>
