...
export const MENU_ITEMS = [
  ...
  { route: "operaciones", label: "Operaciones", icon: "account_tree" },
...
export function createHomeShell(state, options = {}) {
  const rightWidthClass = options.rightWidthClass || "w-[320px]";
...
export function bindHomeShell(root) {
