...
function buildPage(state, bpm, processes) {
  ...
  return `
    <div class="max-w-6xl mx-auto space-y-xl">
      ${renderDetailHeader({ eyebrow: "Ficha BPM", title: "Detalle del proceso", description: "Introduce y mantiene la información escrita de la definición BPM seleccionada.", backHref: "#/procesos", backLabel: "Volver a procesos" })}
