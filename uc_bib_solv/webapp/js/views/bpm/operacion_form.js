...
export function operationFormBody(operation, context = {}) {
  ...
  return `
    ...
    <fieldset class="operation-machine-selector" aria-describedby="operation-machine-help"><legend>Máquinas asociadas</legend><p id="operation-machine-help">Selecciona máquinas del catálogo. La asociación se guarda por ID canónico.</p><div data-operation-machines aria-live="polite"><p class="text-secondary">Cargando catálogo…</p></div></fieldset>
