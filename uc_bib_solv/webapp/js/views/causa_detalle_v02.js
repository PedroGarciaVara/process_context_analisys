    ...
    <div class="p-lg space-y-lg">
      <div class="grid grid-cols-1 gap-sm">
        ...
        <div class="p-sm bg-white rounded border border-outline-variant">
          ...
          <p class="text-title-lg font-bold text-primary break-words whitespace-normal">${escapeHtml(readableContractName)}</p>
        </div>
      </div>
      <div class="p-md bg-surface-container-low rounded-lg border border-outline-variant">
        ...
        <p class="text-[12px] text-on-surface-variant">1. Crea o reutiliza una causa. 2. Guarda el vínculo. 3. Vuelve al árbol y continúa ramificando.</p>
      </div>
    </div>
  `;
}
