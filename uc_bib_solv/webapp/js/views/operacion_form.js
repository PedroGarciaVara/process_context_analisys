...
export function operationFormBody(operation, context = {}) {
  ...
  return `
    <div class="grid grid-cols-1 md:grid-cols-2 gap-lg">
      ...
      <div class="block space-y-xs"><span class="font-label-md text-label-md text-secondary">Versión BPM</span><p class="w-full border border-outline rounded-lg p-sm bg-surface-container-low font-body-sm">${escapeHtml(context.versionLabel || operation?.process_id || "—")}</p></div>
    </div>
